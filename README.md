...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cyberpunk-cat-cloudflare-workers
```

A live public deployment of this template is available at [https://cyberpunk-cat-cloudflare-workers.templates.workers.dev](https://cyberpunk-cat-cloudflare-workers.templates.workers.dev)
